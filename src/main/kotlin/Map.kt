//Map<K, V>  bukan pewaris antarmuka Koleksi
/*
    Peta menyimpan pasangan nilai kunci (atau entri);
    kunci unik, tetapi kunci yang berbeda dapat dipasangkan
...
fun main() {
    ...
    if (numbersMap.containsValue(1))
        println("The value 1 is in the map") //same as previos

    val anotherMap = mapOf("key2" to 2, "key1" to 1, "key4" to 1, "key3" to 3)
    println("The maps are equal: ${numbersMap == anotherMap}")

    //MutableMap adalah Peta dengan operasi penulisan peta
    //misalnya :
